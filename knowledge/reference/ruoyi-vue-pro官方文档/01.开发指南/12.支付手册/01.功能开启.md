---
title: "功能开启"
source_url: "https://doc.iocoder.cn/pay/build/"
official_path: "/01.开发指南/12.支付手册/01.功能开启.html"
...
① [支付 SDK 组件](https://github.com/YunaiV/ruoyi-vue-pro/tree/master/yudao-module-pay/src/main/java/cn/iocoder/yudao/module/pay/framework/pay/core/client)：对接微信、支付宝等支付，提供统一的 PayClient 支付客户端。
...
- 对内提供 [PayOrderApi](https://github.com/YunaiV/ruoyi-vue-pro/blob/master/yudao-module-pay/src/main/java/cn/iocoder/yudao/module/pay/api/order/PayOrderApi.java) 统一支付 API 能力、[PayRefundApi](https://github.com/YunaiV/ruoyi-vue-pro/blob/master/yudao-module-pay/src/main/java/cn/iocoder/yudao/module/pay/api/refund/PayRefundApi.java) 统一退款 API 能力。
...
点击 [pay-2025-07-27.sql.zip](https://t.zsxq.com/15mEuhfnK) 下载附件，解压出 SQL 文件，然后导入到数据库中。
...
- 支付结果的回调地址：每个业务需要实现一个支付回调接口，在用户支付成功时，支付中心会进行回调。[示例订单的支付回调](https://github.com/YunaiV/ruoyi-vue-pro/blob/master/yudao-module-pay/src/main/java/cn/iocoder/yudao/module/pay/controller/admin/demo/PayDemoOrderController.java#L50-L58)、[商城订单的支付回调](https://github.com/YunaiV/ruoyi-vue-pro/blob/master/yudao-module-mall/yudao-module-trade/src/main/java/cn/iocoder/yudao/module/trade/controller/app/order/AppTradeOrderController.java#L64-L70)
- 退款结果的回调地址：每个业务需要实现一个退款回调接口，在用户退款成功时，支付中心会进行回调。[示例订单的退款回调](https://github.com/YunaiV/ruoyi-vue-pro/blob/master/yudao-module-pay/src/main/java/cn/iocoder/yudao/module/pay/controller/admin/demo/PayDemoOrderController.java#L68-L76)、[商城订单的退款回调](https://github.com/YunaiV/ruoyi-vue-pro/blob/master/yudao-module-mall/yudao-module-trade/src/main/java/cn/iocoder/yudao/module/trade/controller/admin/aftersale/AfterSaleController.java#L134)
- 转账结果的回调地址：每个业务需要实现一个退款回调接口，在用户退款成功时，支付中心会进行回调。[示例提现单的转账回调](https://github.com/YunaiV/ruoyi-vue-pro/blob/master-jdk17/yudao-module-pay/src/main/java/cn/iocoder/yudao/module/pay/controller/admin/demo/PayDemoWithdrawController.java#L54-L61)、[商城分销提现的转账回调](https://github.com/YunaiV/ruoyi-vue-pro/blob/master-jdk17/yudao-module-mall/yudao-module-trade/src/main/java/cn/iocoder/yudao/module/trade/controller/admin/brokerage/BrokerageWithdrawController.java#L85-L93)
...
![配置回调地址](https://doc.iocoder.cn/img/%E6%94%AF%E4%BB%98%E6%89%8B%E5%86%8C/%E5%8A%9F%E8%83%BD%E5%BC%80%E5%90%AF/%E9%85%8D%E7%BD%AE%E5%9B%9E%E8%B0%83%E5%9C%B0%E5%9D%80Boot.png)

- `yudao.pay.order-notify-url` 配置项：对应 PayNotifyController 的 [#notifyOrder(...)](https://github.com/YunaiV/ruoyi-vue-pro/blob/master/yudao-module-pay/src/main/java/cn/iocoder/yudao/module/pay/controller/admin/notify/PayNotifyController.java#L59-L98) 方法
- `yudao.pay.refund-notify-url` 配置项：对应 PayNotifyController 的 [#notifyRefund(...)](https://github.com/YunaiV/ruoyi-vue-pro/blob/master/yudao-module-pay/src/main/java/cn/iocoder/yudao/module/pay/controller/admin/notify/PayNotifyController.java#L59-L98) 方法
- `yudao.pay.transfer-notify-url` 配置项：对应 PayNotifyController 的 [#notifyTransfer(...)](https://github.com/YunaiV/ruoyi-vue-pro/blob/master/yudao-module-pay/src/main/java/cn/iocoder/yudao/module/pay/controller/admin/notify/PayNotifyController.java#L107-L127) 方法
...
![提现转账案例](https://doc.iocoder.cn/img/%E6%94%AF%E4%BB%98%E6%89%8B%E5%86%8C/%E6%94%AF%E4%BB%98%E5%AE%9D%E8%BD%AC%E8%B4%A6%E6%8E%A5%E5%85%A5/%E5%8F%91%E8%B5%B7%E8%BD%AC%E8%B4%A6.png)

详细说明，可见如下文档：

- [《支付宝转账接入》](https://doc.iocoder.cn/pay/alipay-transfer-demo)
- [《微信转账接入》](https://doc.iocoder.cn/pay/wx-transfer-demo)

### 3.7 钱包充值、支付、退款

详细可见 [《钱包充值、支付、退款》](https://doc.iocoder.cn/pay/wallet) 文档

### 3.8 模拟支付、退款

详细可见 [《模拟支付、退款》](https://doc.iocoder.cn/pay/mock) 文档

### 3.9 转账订单

对应 [支付管理 -> 转账订单] 菜单，进行转账订单的查看。如下图所示：

![退款订单](https://doc.iocoder.cn/img/%E6%94%AF%E4%BB%98%E6%89%8B%E5%86%8C/%E5%8A%9F%E8%83%BD%E5%BC%80%E5%90%AF/%E8%BD%AC%E8%B4%A6%E8%AE%A2%E5%8D%95.png)
