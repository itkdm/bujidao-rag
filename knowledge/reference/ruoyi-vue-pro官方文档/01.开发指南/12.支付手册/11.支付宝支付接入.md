---
title: "支付宝支付接入"
source_url: "https://doc.iocoder.cn/pay/alipay-pay-demo/"
official_path: "/01.开发指南/12.支付手册/11.支付宝支付接入.html"
crawled_at: "2026-08-09T06:54:50.258Z"
---
## 0. 概述

在 `yudao-module-pay` 模块的 [demo](https://github.com/YunaiV/ruoyi-vue-pro/tree/master/yudao-module-pay/src/main/java/cn/iocoder/yudao/module/pay/controller/admin/demo) 模块，我们提供了一个 **支付** 接入的示例（PayNotifyController）。
...
② 【后端】在 `demo` 模块的下单逻辑中，需要调用 PayOrderApi 的 [#createOrder(...)](https://github.com/YunaiV/ruoyi-vue-pro/blob/master/yudao-module-pay/src/main/java/cn/iocoder/yudao/module/pay/service/demo/PayDemoOrderServiceImpl.java#L91-L96) 方法，创建支付单。如下图所示：
...
在 `demo` 模块所在的 `yudao-module-xx` 模块，实现一个支付回调的接口，提供给支付【中心】回调。对应的代码在 PayDemoOrderController 的 [#updateDemoOrderPaid(...)](https://github.com/YunaiV/ruoyi-vue-pro/blob/master/yudao-module-pay/src/main/java/cn/iocoder/yudao/module/pay/controller/admin/demo/PayDemoOrderController.java#L50-L58) 方法中，如下图所示：
...
选择完支付【渠道】，会调用后端 PayOrderController 的 [#submit(...)](https://github.com/YunaiV/ruoyi-vue-pro/blob/master/yudao-module-pay/src/main/java/cn/iocoder/yudao/module/pay/controller/admin/order/PayOrderController.java#L92-L97) 方法，内部调用对应支付【渠道】的 PayClient 实现类，发起支付。
