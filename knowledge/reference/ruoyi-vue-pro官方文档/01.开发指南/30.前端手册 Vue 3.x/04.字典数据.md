---
title: "字典数据"
source_url: "https://doc.iocoder.cn/vue3/dict/"
official_path: "/01.开发指南/30.前端手册 Vue 3.x/04.字典数据.html"
...
[](https://github.com/yudaocode/yudao-ui-admin-vue3/blob/master/src/components/DictTag/index.ts) 组件，翻译字段对应的字典展示文本，并根据 `colorType`、`cssClass` 进行高亮。使用示例如下：
