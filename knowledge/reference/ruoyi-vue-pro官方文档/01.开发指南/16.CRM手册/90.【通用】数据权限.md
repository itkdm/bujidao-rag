---
title: "【通用】数据权限"
source_url: "https://doc.iocoder.cn/crm/permission/"
official_path: "/01.开发指南/16.CRM手册/90.【通用】数据权限.html"
crawled_at: "2026-08-09T06:54:50.849Z"
---
数据权限，由 `yudao-module-crm` 后端模块的 `permission` 包实现，支持某个人对某个数据（线索、客户、商机、合同等等），有对应的权限。
