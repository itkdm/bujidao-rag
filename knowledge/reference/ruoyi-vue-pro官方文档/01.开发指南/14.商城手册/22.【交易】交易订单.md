---
title: "【交易】交易订单"
source_url: "https://doc.iocoder.cn/mall/trade-order/"
official_path: "/01.开发指南/14.商城手册/22.【交易】交易订单.html"
crawled_at: "2026-08-09T06:54:50.581Z"
---
## 1. 表结构

交易订单，由 `yudao-module-trade` 后端模块的 `order` 包实现，分成三个表：
...
`pay_order_id` 字段：关联的支付中心的支付单号。对支付中心还不了解的同学，可以阅读下 [《支付手册》](https://doc.iocoder.cn/pay/build/) 文档。
...
- VIP 折扣 + 限时折扣：TradeMemberLevelPriceCalculator
...
这块已经在 [《微信公众号支付接入》](https://doc.iocoder.cn/pay/wx-pub-pay-demo/)、[《微信小程序支付接入》](https://doc.iocoder.cn/pay/wx-lite-pay-demo/) 文档中介绍过了，这里就不再赘述。
...
ps：微信小程序的发货，可以使用订阅消息功能，具体可以后面看看 [《微信小程序订阅消息》](https://doc.iocoder.cn/member/weixin-lite-subscribe-message/) 文档。
...
另外，如果使用快递鸟的话，要注意 1002 是免费套餐，8001 是付费套餐，可见 [https://t.zsxq.com/GcSDL](https://t.zsxq.com/GcSDL) 讨论。
...
① 买家点击「评价」按钮，进入评价页，这块已经在 [《【商品】商品评价》](https://doc.iocoder.cn/mall/product-comment/) 文档中介绍过了，这里就不再赘述。
