---
title: "功能开启"
source_url: "https://doc.iocoder.cn/bpm/"
official_path: "/01.开发指南/10.工作流手册/02.功能开启.html"
crawled_at: "2026-08-09T06:54:50.083Z"
---
进度说明：
...
① 修改根目录的 [pom.xml](https://github.com/YunaiV/ruoyi-vue-pro/blob/master/pom.xml) 文件，取消 `yudao-module-bpm` 模块的注释。
...
② 第二步，修改 `yudao-server` 的 [pom.xml](https://github.com/YunaiV/ruoyi-vue-pro/blob/master/yudao-server/pom.xml) 文件，取消 `yudao-module-bpm` 依赖的注释，并进行 IDEA 的 Maven 刷新。
...
点击 [bpm-2025-10-04.sql.zip](https://t.zsxq.com/150EPtWgV) 下载附件，解压出 SQL 文件，然后导入到数据库中。
...
你可以参考 [《审批接入（流程表单）》](https://doc.iocoder.cn/bpm/use-bpm-form/) 文档，自己创建一个流程模型，不会很复杂哈。

② 问题：如果启动中报 [MySQL “Specified key was too long; max key length is 1000 bytes”](https://gitee.com/zhijiantianya/ruoyi-vue-pro/issues/I57FYM) 错误？
...
解决方案：参见 [《工作流（达梦适配）》](https://doc.iocoder.cn/bpm/dameng/) 文档。
...
- [yudao-spring-boot-starter-activiti](https://gitee.com/zhijiantianya/ruoyi-vue-pro/tree/v1.6.2/yudao-framework/yudao-spring-boot-starter-activiti)
- [yudao-module-bpm-biz-activiti](https://gitee.com/zhijiantianya/ruoyi-vue-pro/tree/v1.6.2/yudao-module-bpm/yudao-module-bpm-biz-activiti)
