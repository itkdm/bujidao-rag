---
title: "流程表达式"
source_url: "https://doc.iocoder.cn/bpm/expression/"
official_path: "/01.开发指南/10.工作流手册/31.流程表达式.html"
crawled_at: "2026-08-09T06:54:50.205Z"
---
## 1. 流程表达式
...
- 在 [《会签、或签、依次审批》](https://doc.iocoder.cn/bpm/multi-instance/) 看到的 `${ nrOfCompletedInstances >= nrOfInstances }`、`${ nrOfCompletedInstances == 1 }` 等，就是 UEL 表达式
- 在 [《审批接入（流程表单）》](https://doc.iocoder.cn/bpm/use-business-form/) 看到的流转条件 `${day > 3}`，也是 UEL 表达式
