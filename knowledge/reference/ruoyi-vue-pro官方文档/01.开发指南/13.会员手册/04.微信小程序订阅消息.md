---
title: "微信小程序订阅消息"
source_url: "https://doc.iocoder.cn/member/weixin-lite-subscribe-message/"
official_path: "/01.开发指南/13.会员手册/04.微信小程序订阅消息.html"
crawled_at: "2026-08-09T06:54:50.369Z"
---
前置阅读文章：
...
本文是 [《三方登录》](https://doc.iocoder.cn/social-user/) 的延伸，讲解 [yudao-mall-uniapp](https://github.com/yudaocode/yudao-mall-uniapp) 商城小程序如何实现微信 **小程序** 订阅消息的功能。对应的官方文档如下：
...
在后端 [发送订阅消息](https://developers.weixin.qq.com/miniprogram/dev/OpenApiDoc/mp-message-management/subscribe-message/sendMessage.html) 时，需要传递 `miniprogram_state` 参数，用于区分跳转小程序类型：
