---
title: "【其它】WMS、MES、ERP 对比"
source_url: "https://doc.iocoder.cn/wms/compare/"
official_path: "/01.开发指南/20.WMS手册/90.【其它】WMS、MES、ERP 对比.html"
crawled_at: "2026-08-09T06:54:51.876Z"
---
...
**不涉及**：采购订单 / 销售订单 / 应收应付 / 财务结算 / 生产工单 / 工序工艺 / 质检 / 设备 / 工具 / 排班；也**不涉及**库区库位、批次、生产日期、过期日期、SN 一物一码（详见 [《功能开启》](https://doc.iocoder.cn/wms/build/)）。

详见 [《WMS 演示》](https://doc.iocoder.cn/wms-preview/)。
...
详见 [《MES 手册》](https://doc.iocoder.cn/mes-preview/)。
...
详见 [《ERP 手册》](https://doc.iocoder.cn/erp-preview)。
...
- 选 WMS：参考 [《功能开启》](https://doc.iocoder.cn/wms/build/)，3 分钟开起来；后续按 [《WMS 演示》](https://doc.iocoder.cn/wms-preview/) 的 5 节表结构按需读模块文档。
- 选 MES：参考 [《MES 手册 —— 功能开启》](https://doc.iocoder.cn/mes/build/)。
- 选 ERP：参考 [《ERP 手册 —— 功能开启》](https://doc.iocoder.cn/erp/build/)。
