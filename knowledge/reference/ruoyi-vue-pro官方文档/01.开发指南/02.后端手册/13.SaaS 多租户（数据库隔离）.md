...
source_url: "https://doc.iocoder.cn/saas-tenant/dynamic/"
official_path: "/01.开发指南/02.后端手册/13.SaaS 多租户（数据库隔离）.html"
crawled_at: "2026-08-09T06:54:49.698Z"
---
...
③ 下载 [多租户多db.zip](https://doc.iocoder.cn/file/%E5%A4%9A%E7%A7%9F%E6%88%B7%E5%A4%9Adb.zip) 并解压，将 SQL 导入到对应的数据库中。
...
③ 每个主库对应的 Mapper，必须添加 [@Master](https://github.com/baomidou/dynamic-datasource/blob/master/dynamic-datasource-spring/src/main/java/com/baomidou/dynamic/datasource/annotation/Master.java) 注解。例如说：
...
③ 每个主库对应的 Mapper，必须添加 [@TenantDS](https://doc.iocoder.cn/TODO) 注解。例如说：
...
- 使用 [Atomikos](https://cloud.tencent.com/developer/article/1436662) 实现 JTA 分布式事务，配置复杂，性能较差。
- 使用 [Seata](https://www.iocoder.cn/Seata/install/) 实现分布式事务，使用简单，性能不错，但是需要额外引入 Seata Server 服务。
