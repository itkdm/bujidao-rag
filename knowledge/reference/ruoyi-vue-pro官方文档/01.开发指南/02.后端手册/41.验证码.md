---
title: "验证码"
source_url: "https://doc.iocoder.cn/captcha/"
official_path: "/01.开发指南/02.后端手册/41.验证码.html"
crawled_at: "2026-08-09T06:54:49.965Z"
---
...
① 后端的 `application-local.yaml` 配置文件中，将 [yudao.captcha.enable](https://github.com/YunaiV/ruoyi-vue-pro/blob/master/yudao-server/src/main/resources/application-local.yaml#L225-L227) 设置为 `false`。
...
`yudao-module-system` 模块，默认在 [pom.xml](https://github.com/YunaiV/ruoyi-vue-pro/blob/master/yudao-module-system/pom.xml#L104-L107)) 已经引入 `captcha-spring-boot-starter` 依赖，代码如下：
...
如果你想修改验证码的 **图片**，修改 [resources/images](https://github.com/YunaiV/ruoyi-vue-pro/tree/master/yudao-module-system/src/main/resources/images) 目录即可。
