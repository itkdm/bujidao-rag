---
title: "SaaS 多租户【字段隔离】"
source_url: "https://doc.iocoder.cn/saas-tenant/"
official_path: "/01.开发指南/02.后端手册/12.SaaS 多租户（字段隔离）.html"
crawled_at: "2026-08-09T06:54:49.749Z"
---
...
- 在 `system_tenant` 表里，有个 `website` 字段为该租户的独立域名，你可以填写你希望分配给它的子域名。
- 在 Nginx 上做 **泛域名解析** 到你的前端项目，例如说 Nginx 的 `server_name` `*.iocoder.cn` 解析到 Vue3 管理后台。
