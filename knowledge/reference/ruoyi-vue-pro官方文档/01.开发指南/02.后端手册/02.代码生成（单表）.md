---
title: "代码生成【单表】（新增功能）"
source_url: "https://doc.iocoder.cn/new-feature/"
official_path: "/01.开发指南/02.后端手册/02.代码生成（单表）.html"
crawled_at: "2026-08-09T06:54:49.628Z"
---
大部分项目里，其实有很多代码是重复的，几乎每个模块都有 CRUD 增删改查的功能，而这些功能的实现代码往往是大同小异的。如果这些功能都要自己去手写，非常无聊枯燥，浪费时间且效率很低，还可能会写错。

所以这种重复性的代码，项目提供了 [codegen](https://github.com/YunaiV/ruoyi-vue-pro/tree/master/yudao-module-infra/src/main/java/cn/iocoder/yudao/module/infra/service/codegen) 代码生成器，只需要在数据库中设计好表结构，就可以一键生成前后端代码 + 单元测试 + Swagger 接口文档 + Validator 参数校验。
...
可见 [CodegenBuilder](https://github.com/YunaiV/ruoyi-vue-pro/blob/master/yudao-module-infra/src/main/java/cn/iocoder/yudao/module/infra/service/codegen/inner/CodegenBuilder.java) 类，自动解析数据库的表结构，生成默认的配置。
...
| yudao-ui-admin-vben（antdv-next） | Vben5.0 Antdv Next Schema 模版 |
| yudao-ui-admin-vben（ele） | Vben5.0 Element Plus Schema 模版 |
...
![代码预览](https://doc.iocoder.cn/img/%E4%BB%A3%E7%A0%81%E7%94%9F%E6%88%90/%E5%8D%95%E8%A1%A8/%E4%BB%A3%E7%A0%81%E9%A2%84%E8%A7%88Boot.png)
...
![生成代码](https://doc.iocoder.cn/img/%E4%BB%A3%E7%A0%81%E7%94%9F%E6%88%90/%E5%8D%95%E8%A1%A8/%E4%BB%A3%E7%A0%81%E7%94%9F%E6%88%90Boot.png)

代码实现？

可见 [CodegenEngine](https://github.com/YunaiV/ruoyi-vue-pro/blob/master/yudao-module-infra/src/main/java/cn/iocoder/yudao/module/infra/service/codegen/inner/CodegenEngine.java) 类，基于 Velocity 模板引擎，生成具体代码。模板文件，可见 [resources/codegen](https://github.com/YunaiV/ruoyi-vue-pro/tree/master/yudao-module-infra/src/main/resources/codegen) 目录。
...
![复制后端](https://doc.iocoder.cn/img/%E4%BB%A3%E7%A0%81%E7%94%9F%E6%88%90/%E5%8D%95%E8%A1%A8/%E5%A4%8D%E5%88%B6%E5%90%8E%E7%AB%AFBoot.png)

② 将 `ErrorCodeConstants.java_手动操作` 文件的错误码，复制到该模块 ErrorCodeConstants 类中，并设置对应的错误码编号，之后进行删除。操作如下图所示：

![添加错误码](https://doc.iocoder.cn/img/%E4%BB%A3%E7%A0%81%E7%94%9F%E6%88%90/%E5%8D%95%E8%A1%A8/%E6%B7%BB%E5%8A%A0%E9%94%99%E8%AF%AF%E7%A0%81Boot.png)
...
![复制 h2 SQL](https://doc.iocoder.cn/img/%E4%BB%A3%E7%A0%81%E7%94%9F%E6%88%90/%E5%8D%95%E8%A1%A8/%E5%A4%8D%E5%88%B6H2-Boot.png)
...
⑤ Debug 运行 YudaoServerApplication 类，启动后端项目。通过 IDEA 的 [Mappings] 菜单，可以看到代码生成的 GroupController 的 RESTful API 接口已经生效。
...
- 一般来说，新增/修改是不传递 `createTime`、`creator` 等字段，响应是需要返回 `createTime`、`creator` 等字段，两者的字段无法不一致。
...
如果有需要，可以参考 [#1131](https://gitee.com/zhijiantianya/ruoyi-vue-pro/pulls/1131) 和 [#1139](https://gitee.com/zhijiantianya/ruoyi-vue-pro/pulls/1139) 支持。
...
修改后端的 `application.yaml` 配置文件中的 `yudao.codegen.import-enable` 配置项为 `true`（默认 `false`），然后重新生成代码，会一并生成导入按钮、`ImportForm` 组件以及后端的 `importExcel` 接口与模板下载接口。

⑧ 如果我是 pgsql 数据库，怎么解决 menu 菜单的生成？

参见 [https://t.zsxq.com/pQypk](https://t.zsxq.com/pQypk) 帖子改造。

## 666. 社区贡献相关

- [《Pull Request：允许同时生成管理端代码和用户 APP 代码》](https://github.com/YunaiV/ruoyi-vue-pro/pull/999)
- [《Pull Request：支持 businessName 包含子目录》](https://github.com/YunaiV/ruoyi-vue-pro/pull/997)
- 《Pull Request：快速生成代码到指定项目目录》：[后端代码](https://gitee.com/yudaocode/yudao-boot-mini/pulls/4)、[前端代码](https://gitee.com/yudaocode/yudao-ui-admin-vue3/pulls/791)
- 《Pull Request：代码生成预览时检查类名称是否重复》：[后端代码](https://github.com/YunaiV/ruoyi-vue-pro/pull/1034/)、[前端代码](https://github.com/yudaocode/yudao-ui-admin-vue3/pull/207)
