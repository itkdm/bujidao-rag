---
title: "HTTP 接口加解密"
source_url: "https://doc.iocoder.cn/api-encrypt/"
official_path: "/01.开发指南/02.后端手册/35.HTTP 加解密.html"
crawled_at: "2026-08-09T06:54:49.949Z"
---
...
yudao:
  api-encrypt:
    enable: false # 是否开启 API 加密。默认关闭，避免低版本 JDK 8（8u120 以下）启动时 bcprov 的 JCE 认证报错；需要时改成 true
...
ApiEncryptFilter 的构造方法里，有创建加解密 Encryptor、Decryptor 的逻辑，增加下对应的逻辑即可，使用 hutool 工具类的 SM2、SM4 即可。
当然，要注意引入下 SM2、SM4 的 Maven 依赖噢。
...
对加密算法了解不多的同学，可以看看 [《什么是公钥和私钥？》](https://help.aliyun.com/zh/ssl-certificate/what-are-a-public-key-and-a-private-key) 文档。
...
当然，你也可以使用 [http://web.chacuo.net/netrsakeypair](http://web.chacuo.net/netrsakeypair) 生成。
...
参见 [《Java 解密 AES-256 失败，秘钥长度受限制问题》](https://blog.csdn.net/LiZhen314/article/details/143357715)
