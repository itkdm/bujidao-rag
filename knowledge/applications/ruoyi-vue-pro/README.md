---
# 知识库导航基础设施文件
id: KB-INFRA-APP-RUOYI-VUE-PRO-README
scope: app
...
`applications/ruoyi-vue-pro/` 是若依 RuoYi-Vue-Pro 应用的「应用层」知识目录，集中存放该应用范围内的知识，与 `main/` 的跨应用通用知识相互区分。

## 应包含的内容

- 应用总览：根目录的 `ruoyi-vue-pro.md`，描述该应用本身是什么。
...
- 应用的实际业务信息（技术栈、核心模块、业务目标、系统边界等）：属于 `ruoyi-vue-pro.md`，不写进本目录 README。
