---
# ==================== 必填字段 ====================
id: KB-BASE-KUAYOU-RUOYI-VUE-PRO-PERMISSION
type: base
scope: ruoyi-vue-pro
# 业务归属
domain: kuayou
...
anchors:
  - APPLICATION:ruoyi-vue-pro
  - BASE_AREA:permission
  - BASE_TOPIC:permission-index
---
...
本文不定义夸友业务角色和权限矩阵；角色规则应进入 `domain/rule/` 或正式产品文档。
...
| `domain/feature/` | 功能流程会引用具体接口权限 |
| `domain/rule/` | 角色权限矩阵应进入 rule |
